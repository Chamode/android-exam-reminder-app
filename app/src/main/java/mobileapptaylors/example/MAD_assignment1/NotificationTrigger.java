...
public class NotificationTrigger extends IntentService {
    ...
    private static final String ALARM = "mobileapptaylors.example.MAD_assignment1.ALARM";
    ...
    private void handleAlarm() {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(this)
                .setSmallIcon(mobileapptaylors.example.MAD_assignment1.R.drawable.ic_access_alarms_black_24dp)
                .setContentTitle("Next Exam Slot")
                .setTicker(this.getString(mobileapptaylors.example.MAD_assignment1.R.string.app_name))
