...
public class ViewSlots extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(mobileapptaylors.example.MAD_assignment1.R.layout.activity_view_slots);
        setTitle("View Slots");
        android.support.v7.app.ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
        Stetho.initializeWithDefaults(this);
        RecyclerView recList = (RecyclerView) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.cardList);
