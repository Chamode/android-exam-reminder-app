...
//            date.requestFocus();
    ...
    public void showDialog(Activity activity, String title, CharSequence message) {
        AlertDialog.Builder builder = new AlertDialog.Builder(activity, mobileapptaylors.example.MAD_assignment1.R.style.DialogeTheme);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(mobileapptaylors.example.MAD_assignment1.R.layout.activity_add_slots);
        setTitle("Add Slots");
        android.support.v7.app.ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayHomeAsUpEnabled(true);
//        final EditText subjectName = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.subjectName);
//        final EditText subjectName = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.subjectName);
        final EditText date = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.date);
        final EditText time = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.time);
        final EditText timeEnd = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.time_end);
        final EditText location = (EditText) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.location);

        // Drop down menu
        spinner = (Spinner) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.spinner);
        ...
        Button addSlotButton = (Button) findViewById(mobileapptaylors.example.MAD_assignment1.R.id.addSlotsButton);
